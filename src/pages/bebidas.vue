  ...
  setup() {
    ...
    const Bebidas = ref({
      tipos: [
        ...
        { nome: "Coca Guaraná 1L", quantidade: 0, preco: 10 },
        { nome: "Cajuína 1L", quantidade: 0, preco: 10 },
        { nome: "Suco de Goiaba Copo", quantidade: 0, preco: 5 },
        { nome: "Suco de Manga & Acerola Copo", quantidade: 0, preco: 6 },
        { nome: "Suco de Maracujá Copo", quantidade: 0, preco: 6 },
        { nome: "Suco de Goiaba Jarra", quantidade: 0, preco: 12 },
        { nome: "Suco de Manga Jarra", quantidade: 0, preco: 12 },
        { nome: "Suco de Acerola Jarra", quantidade: 0, preco: 12 },
