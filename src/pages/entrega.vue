...
export default {
  setup() {
    ...
    const taxaLocalidade = ref([
      { nome: "João XXIII", preco: 3.0 },
      { nome: "José Simões", preco: 4.0 },
      { nome: "Monsenhor Otávio", preco: 4.0 },
      { nome: "Eucaliptos", preco: 4.0 },
      { nome: "Centro", preco: 4.0 },
      { nome: "Brotolândia", preco: 4.0 },
      { nome: "Socorro", preco: 5.0 },
      { nome: "Pitombeira", preco: 4.0 },
      { nome: "Habitar Brasil", preco: 5.0 },
      { nome: "Limoeirinho", preco: 5.0 },
      { nome: "Sítio Milagres", preco: 8.0 },
      { nome: "Córrego de Areia", preco: 8.0 },
      ...
      { nome: "Espinho", preco: 20.0 },
      { nome: "Ilha", preco: 6.0 },
      { nome: "Luiz Alves", preco: 5.0 },
      { nome: "Conjunto das Flores", preco: 6.0 },
      { nome: "Canafístula", preco: 7.0 },
      { nome: "São Raimundo", preco: 7.0 },
      { nome: "Varginha", preco: 10.0 },
      { nome: "Arraial", preco: 12.0 },
      { nome: "Pedra Branca", preco: 15.0 },
      { nome: "Maria Dias", preco: 15.0 },
      { nome: "Várzea do Cobra", preco: 8.0 },
      { nome: "Sítio Pasto", preco: 8.0 },
      { nome: "Sítio Marquinhos", preco: 8.0 },
      { nome: "Genipapeiro", preco: 10.0 },
      { nome: "Bom Fim", preco: 7.0 },
      { nome: "Sítio Morros", preco: 8.0 },
      { nome: "Quixaba", preco: 8.0 },
      { nome: "Boa Fé", preco: 5.0 },
      { nome: "Bom Nome", preco: 4.0 },
      { nome: "Santa Luzia", preco: 4.0 },
      { nome: "Vila Tetel", preco: 5.0 },
      { nome: "Vila do Alonso", preco: 5.0 },
      { nome: "Populares", preco: 4.0 },
      { nome: "Barragem das Pedrinhas", preco: 8.0 },
    ]);

    function copyToClipboard() {
      navigator.clipboard
        .writeText("74204963315")
        .then(() => {
